...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__("W2nU"), __webpack_require__("DuR2")))
...
__webpack_require__("wFBm");
__webpack_require__("Flb4");
__webpack_require__("YVjH");
__webpack_require__("PSx8");
__webpack_require__("BUXd");
__webpack_require__("hgz2");
module.exports = __webpack_require__("beqJ");
...
//同步引入
//依赖jquery,jquery.cookie.js
var setSaUrl = {
  'vipkid': 'https://sensorsdata.vipkid.com.cn/sa',
  'testvipkid': 'http://sc.vipkid.com.cn:8006/sa?project=test'
};
(function (para) {
  var n = para.name;
...
function getSa() {
  if (window.location.hostname === 'lc.vipkid.com.cn' || window.location.hostname === 'pre-lc.vipkid.com.cn') {
    return setSaUrl['vipkid'];
  } else {
    return setSaUrl['testvipkid'];
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_oaxios__ = __webpack_require__("mtWM");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_oaxios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_oaxios__);

var cookies = __webpack_require__("wFBm");
__WEBPACK_IMPORTED_MODULE_0_oaxios___default.a.interceptors.request.use(function (config) {
  var cookieAuth = cookies.get('Authorization');
  var cookie_session = cookies.get('vk_session_id');
  if (cookie_session) {
...
__WEBPACK_IMPORTED_MODULE_0_oaxios___default.a.interceptors.response.use(function (response) {
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0_oaxios___default.a);
...
try {
  !function (sd) {
    function app_js_bridge() {
      function e(e) {
        ...
        if (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream) {
          ...
          i = null;window.sensorsdata_app_js_bridge_call_js = function (t) {
        e(t);
      }, sd.getAppStatus = function (e) {
        return r(), t(), e ? void (null === n ? i = e : e(n)) : n;
      };
    }if (sd = window[sd], "function" != typeof sd && "object" != (typeof sd === "undefined" ? "undefined" : _typeof(sd)) || sd.has_load_sdk) return !1;sd._t = sd._t || 1 * new Date(), sd.has_load_sdk = !0, "object" != (typeof JSON === "undefined" ? "undefined" : _typeof(JSON)) && (JSON = {}), function () {
      "use strict";
      function f(e) {
        return 10 > e ? "0" + e : e;
      }function this_value() {
        ...
        var r,
            ...
            a,
            s = gap,
            c = t[e];switch (c && "object" == (typeof c === "undefined" ? "undefined" : _typeof(c)) && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c === "undefined" ? "undefined" : _typeof(c)) {case "string":
            ...
            if (!c) return "null";if (gap += indent, a = [], "[object Array]" === Object.prototype.toString.apply(c)) {
              for (o = c.length, r = 0; o > r; r += 1) {
                a[r] = str(r, c) || "null";
              }return i = 0 === a.length ? "[]" : gap ? "[\n" + gap + a.join(",\n" + gap) + "\n" + s + "]" : "[" + a.join(",") + "]", gap = s, i;
            }if (rep && "object" == (typeof rep === "undefined" ? "undefined" : _typeof(rep))) for (o = rep.length, r = 0; o > r; r += 1) {
              "string" == typeof rep[r] && (n = rep[r], i = str(n, c), i && a.push(quote(n) + (gap ? ": " : ":") + i));
            } else for (n in c) {
              Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c), i && a.push(quote(n) + (gap ? ": " : ":") + i));
            }return i = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + s + "}" : "{" + a.join(",") + "}", gap = s, i;}
      }var rx_one = /^[\],:{}\s]*$/,
        ...
        var n;if (gap = "", indent = "", "number" == typeof r) for (n = 0; r > n; n += 1) {
          indent += " ";
        ...
        function walk(e, t) {
          var r,
              n,
              i = e[t];if (i && "object" == (typeof i === "undefined" ? "undefined" : _typeof(i))) for (r in i) {
    ...
    }();var _ = sd._ = {};sd.para = sd.para || {}, sd.para_default = { max_referrer_string_length: 200, max_string_length: 500, cross_subdomain: !0, show_log: !0, debug_mode: !1, debug_mode_upload: !1, session_time: 0, use_client_time: !1, source_channel: [], vtrack_ignore: {}, auto_init: !0, is_single_page: !1, is_trackLink: !0, is_track_device_id: !1, use_app_track: !1 };for (var i in sd.para_default) {
      void 0 === sd.para[i] && (sd.para[i] = sd.para_default[i]);
    }/sa\.gif[^\/]*$/.test(sd.para.server_url) || (sd.para.server_url = sd.para.server_url.replace(/\/sa$/, "/sa.gif").replace(/(\/sa)(\?[^\/]+)$/, "/sa.gif$2")), sd.para.debug_mode_url = sd.para.debug_mode_url || sd.para.server_url.replace("sa.gif", "debug"), sd.para.noCache === !0 ? sd.para.noCache = "?" + new Date().getTime() : sd.para.noCache = "";var ArrayProto = Array.prototype,
        FuncProto = Function.prototype,
        ObjProto = Object.prototype,
        slice = ArrayProto.slice,
        toString = ObjProto.toString,
        hasOwnProperty = ObjProto.hasOwnProperty,
        LIB_VERSION = "1.7.10";sd.lib_version = LIB_VERSION;var error_msg = [],
        is_first_visitor = !1,
        ...
        logger = "object" == (typeof logger === "undefined" ? "undefined" : _typeof(logger)) ? logger : {};logger.info = function () {
      if (!sd.para.show_log) return !1;if ("object" == (typeof console === "undefined" ? "undefined" : _typeof(console)) && console.log) try {
      ...
      var e = (FuncProto.bind, ArrayProto.forEach),
        ...
        if (null == t) return !1;if (e && t.forEach === e) t.forEach(r, i);else if (t.length === +t.length) {
          for (var o = 0, a = t.length; a > o; o++) {
            if (o in t && r.call(i, t[o], o, t) === n) return !1;
          }
        } else for (var s in t) {
          if (hasOwnProperty.call(t, s) && r.call(i, t[s], s, t) === n) return !1;
        }
        ...
        var t = [];return null == e ? t : (i(e, function (e) {
          t[t.length] = e;
        }), t);
      }, _.include = function (e, r) {
        var o = !1;return null == e ? o : t && e.indexOf === t ? -1 != e.indexOf(r) : (i(e, function (e) {
      ...
      e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n");var t,
          ...
          n,
          i = "",
          o = 0;for (t = r = 0, o = e.length, n = 0; o > n; n++) {
        var a = e.charCodeAt(n),
            s = null;128 > a ? r++ : s = a > 127 && 2048 > a ? String.fromCharCode(a >> 6 | 192, 63 & a | 128) : String.fromCharCode(a >> 12 | 224, a >> 6 & 63 | 128, 63 & a | 128), null !== s && (r > t && (i += e.substring(t, r)), i += s, t = r = n + 1);
      ...
      var t,
          ...
          u = 0,
          f = "",
          p = [];if (!e) return e;e = _.utf8Encode(e);do {
        t = e.charCodeAt(d++), r = e.charCodeAt(d++), n = e.charCodeAt(d++), c = t << 16 | r << 8 | n, i = c >> 18 & 63, o = c >> 12 & 63, a = c >> 6 & 63, s = 63 & c, p[u++] = l.charAt(i) + l.charAt(o) + l.charAt(a) + l.charAt(s);
      } while (d < e.length);switch (f = p.join(""), e.length % 3) {case 1:
          f = f.slice(0, -2) + "==";break;case 2:
      ...
      var e = function e() {
        ...
        function t(e, t) {
          var r,
            ...
            o = [],
            a = 0;for (r = 0; r < i.length; r++) {
          n = i.charCodeAt(r), o.unshift(255 & n), o.length >= 4 && (a = t(a, o), o = []);
        }return o.length > 0 && (a = t(a, o)), a.toString(16);
      };return function () {
        var n = String(screen.height * screen.width);n = n && /\d{5,}/.test(n) ? n.toString(16) : String(31242 * Math.random()).replace(".", "").slice(0, 8);var i = e() + "-" + t() + "-" + r() + "-" + n + "-" + e();return i ? (just_test_distinctid_2 = 1, i) : (just_test_distinctid_2 = 2, (String(Math.random()) + String(Math.random()) + String(Math.random())).slice(2, 15));
      };
    }(), _.getQueryParam = function (e, t) {
      t = t.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");var r = "[\\?&]" + t + "=([^&#]*)",
          n = new RegExp(r),
          i = n.exec(e);return null === i || i && "string" != typeof i[1] && i[1].length ? "" : _.decodeURIComponent(i[1]).replace(/\+/g, " ");
    }, _.urlParse = function (e) {
      var t = function t(e) {
        this._fields = { Username: 4, Password: 5, Port: 7, Protocol: 2, Host: 6, Path: 8, URL: 0, QueryString: 9, Fragment: 10 }, this._values = {}, this._regex = null, this._regex = /^((\w+):\/\/)?((\w+):?(\w+)?@)?([^\/\?:]+):?(\d+)?(\/?[^\?#]+)?\??([^#]+)?#?(\w*)/, "undefined" != typeof e && this._parse(e);
      ...
      function r() {
        var e = document;return null != e.pageXOffset ? { x: e.pageXOffset, y: e.pageYOffset } : { x: e.documentElement.scrollLeft, y: e.documentElement.scrollTop };
      }function n(t) {
        t = t || window.event;var n = r();e.style.left = t.clientX + n.x - d + "px", e.style.top = t.clientY + n.y - u + "px", t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0;
      }function i(e) {
        e || (e = window.event), document.removeEventListener ? (document.removeEventListener("mouseup", i), document.removeEventListener("mousemove", n)) : document.detachEvent && (document.detachEvent("onmouseup", i), document.detachEvent("onmousemove", n)), e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !0;
          ...
          l = e.offsetTop,
          d = a - c,
          u = s - l;document.addEventListener ? (document.addEventListener("mousemove", n), document.addEventListener("mouseup", i)) : document.attachEvent && (document.attachEvent("onmousemove", n), document.attachEvent("onmouseup", i)), t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, t.preventDefault ? t.preventDefault() : t.returnValue = !1;
      ...
      }var n = !1;if (document.addEventListener) document.addEventListener("DOMContentLoaded", t, !1);else if (document.attachEvent) {
        try {
          var i = null != window.frameElement;
        } catch (o) {}document.documentElement.doScroll && !i && r(), document.attachEvent("onreadystatechange", function () {
      ...
      function e(e, r, n) {
        var i = function i(_i) {
          if (_i = _i || t(window.event)) {
            _i.target = _i.srcElement;var o,
                a,
                s = !0;return _.isFunction(n) && (o = n(_i)), a = r.call(e, _i), (!1 === o || !1 === a) && (s = !1), s;
          }
        };return i;
      }function t(e) {
        return e && (e.preventDefault = t.preventDefault, e.stopPropagation = t.stopPropagation), e;
      }var r = function r(t, _r, n) {
        if (t && t.addEventListener) t.addEventListener(_r, n, !1);else {
          var i = "on" + _r,
              o = t[i];t[i] = e(t, n, o);
        }
      ...
      }, set: function set(e, t, r, n, i) {
        n = "undefined" == typeof n ? sd.para.cross_subdomain : n;var o = "",
            a = "",
            s = "";if (r = null == r ? 73e3 : r, n) {
          var c = _.url("domain", location.href);o = c ? "; domain=." + c : "";
        }if (0 !== r) {
          var l = new Date();"s" === String(r).slice(-1) ? l.setTime(l.getTime() + 1e3 * Number(String(r).slice(0, -1))) : l.setTime(l.getTime() + 24 * r * 60 * 60 * 1e3), a = "; expires=" + l.toGMTString();
      ...
      }, getCookieName: function getCookieName(e) {
        var t = "";return sd.para.cross_subdomain === !1 ? (t = _.url("sub", location.href), t = "string" == typeof t && "" !== t ? "sajssdk_2015_" + e + "_" + t : "sajssdk_2015_root_" + e) : t = "sajssdk_2015_cross_" + e, t;
      }, getNewUser: function getNewUser() {
        var e = "new_user";return null !== this.get("sensorsdata_is_new_user") || null !== this.get(this.getCookieName(e)) ? !0 : !1;
      } }, _.getEleInfo = function (e) {
      if (!e.target) return !1;var t = e.target,
          r = t.tagName.toLowerCase(),
          n = {};if (n.$element_type = r, n.$element_name = t.getAttribute("name"), n.$element_id = t.getAttribute("id"), n.$element_class_name = "string" == typeof t.className ? t.className : null, n.$element_target_url = t.getAttribute("href"), t.textContent) {
        var i = _.trim(t.textContent);i && (i = i.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)), n.$element_content = i || "";
      }return n = _.strip_empty_properties(n), n.$url = location.href, n.$url_path = location.pathname, n.$title = document.title, n;
      ...
      if (e) {
        var t = new XMLHttpRequest();return "withCredentials" in t ? t : "undefined" != typeof XDomainRequest ? new XDomainRequest() : t;
      }if (XMLHttpRequest) return new XMLHttpRequest();if (window.ActiveXObject) try {
      ...
      function t(e) {
      ...
      }var r = _.xhr(e.cors);e.type || (e.type = e.data ? "POST" : "GET"), e = _.extend({ success: function success() {}, error: function error() {} }, e), r.onreadystatechange = function () {
        ...
        if (r.withCredentials = !0, _.isObject(e.header)) for (var n in e.header) {
          r.setRequestHeader(n, e.header[n]);
      ...
      function e() {
        ...
        var r = e.charAt(0),
            n = t.split(r);return r === e ? n : (e = parseInt(e.substring(1), 10), n[0 > e ? n.length + e : e - 1]);
      }function n(e, r) {
        for (var n = e.charAt(0), i = r.split("&"), o = [], a = {}, s = [], c = e.substring(1), l = 0, d = i.length; d > l; l++) {
          if (o = i[l].match(/(.*?)=(.*)/), o || (o = [i[l], i[l], ""]), "" !== o[1].replace(/\s/g, "")) {
            if (o[2] = t(o[2] || ""), c === o[1]) return o[2];s = o[1].match(/(.*)\[([0-9]+)\]/), s ? (a[s[1]] = a[s[1]] || [], a[s[1]][s[2]] = o[2]) : a[o[1]] = o[2];
          }
        }return n === e ? a : a[c];
      }return function (t, i) {
        var o,
            a = {};if ("tld?" === t) return e();if (i = i || window.location.toString(), !t) return i;if (t = t.toString(), o = i.match(/^mailto:([^\/].+)/)) a.protocol = "mailto", a.email = o[1];else {
          if ((o = i.match(/(.*?)\/#\!(.*)/)) && (i = o[1] + o[2]), (o = i.match(/(.*?)#(.*)/)) && (a.hash = o[2], i = o[1]), a.hash && t.match(/^#/)) return n(t, a.hash);if ((o = i.match(/(.*?)\?(.*)/)) && (a.query = o[2], i = o[1]), a.query && t.match(/^\?/)) return n(t, a.query);if ((o = i.match(/(.*?)\:?\/\/(.*)/)) && (a.protocol = o[1].toLowerCase(), i = o[2]), (o = i.match(/(.*?)(\/.*)/)) && (a.path = o[2], i = o[1]), a.path = (a.path || "").replace(/^([^\/])/, "/$1").replace(/\/$/, ""), t.match(/^[\-0-9]+$/) && (t = t.replace(/^([^\/])/, "/$1")), t.match(/^\//)) return r(t, a.path.substring(1));if (o = r("/-1", a.path.substring(1)), o && (o = o.match(/(.*?)\.(.*)/)) && (a.file = o[0], a.filename = o[1], a.fileext = o[2]), (o = i.match(/(.*)\:([0-9]+)$/)) && (a.port = o[2], i = o[1]), (o = i.match(/(.*?)@(.*)/)) && (a.auth = o[1], i = o[2]), a.auth && (o = a.auth.match(/(.*)\:(.*)/), a.user = o ? o[1] : a.auth, a.pass = o ? o[2] : void 0), a.hostname = i.toLowerCase(), "." === t.charAt(0)) return r(t, a.hostname);e() && (o = a.hostname.match(e()), o && (a.tld = o[3], a.domain = o[2] ? o[2] + "." + o[3] : void 0, a.sub = o[1] || void 0)), a.port = a.port || ("https" === a.protocol ? "443" : "80"), a.protocol = a.protocol || ("443" === a.port ? "https" : "http");
      ...
      this.ele = e;
        ...
        var t = " " + this.ele.className + " ";return -1 === t.indexOf(" " + e + " ") && (this.ele.className = this.ele.className + ("" === this.ele.className ? "" : " ") + e), this;
      }, removeClass: function removeClass(e) {
        var t = " " + this.ele.className + " ";return -1 !== t.indexOf(" " + e + " ") && (this.ele.className = t.replace(" " + e + " ", "").slice(1, -1)), this;
      }, hasClass: function hasClass(e) {
        var t = " " + this.ele.className + " ";return -1 !== t.indexOf(" " + e + " ") ? !0 : !1;
        ...
        var e = this.ele.getBoundingClientRect();if (e.width || e.height) {
          var t = this.ele.ownerDocument,
              r = t.documentElement;return { top: e.top + window.pageYOffset - r.clientTop, left: e.left + window.pageXOffset - r.clientLeft };
        }
      ...
      if ("string" != typeof e) return logger.info("错误", e), [];try {
        return document.querySelectorAll(e);
      } catch (t) {
        return logger.info("错误", e), [];
      }
    }, _.getReferrer = function (e) {
      var e = e || document.referrer;return 0 === e.indexOf("https://www.baidu.com/") && (e = e.split("?")[0]), e = e.slice(0, sd.para.max_referrer_string_length), "string" == typeof e ? e : "";
    }, _.info = { initPage: function initPage() {
        var e = _.getReferrer(),
            t = e ? _.url("hostname", e) : e,
            r = e ? _.url("domain", e) : e,
            n = location.href,
            i = n ? _.url("hostname", n) : n,
            o = n ? _.url("domain", n) : n;this.pageProp = { referrer: e, referrer_host: t, referrer_domain: r, url: n, url_host: i, url_domain: o };
        ...
        e = e || "", t = t || "";var r = _.info.campaignParams(),
            n = {},
            i = {};for (var o in r) {
          -1 !== (" " + source_channel_standard + " ").indexOf(" " + o + " ") ? n[e + o] = r[o] : i[t + o] = r[o];
        }return { $utms: n, otherUtms: i };
      }, properties: function properties() {
        return { $screen_height: Number(screen.height) || 0, $screen_width: Number(screen.width) || 0, $lib: "js", $lib_version: String(LIB_VERSION) };
      ...
      ++this._receive;var r = "_state" + this._receive,
          n = this;this[r] = document.createElement("img"), this[r].onload = this[r].onerror = function (e) {
        n[r].onload = null, n[r].onerror = null, delete n[r], ++n._complete, "function" == typeof t && t();
      }, e._nocache = (String(Math.random()) + String(Math.random()) + String(Math.random())).replace(/\./g, "").slice(0, 15), logger.info(e), e = JSON.stringify(e), sd.is_heatmap_render_mode ? this[r].src = sd.para.server_url : -1 !== sd.para.server_url.indexOf("?") ? this[r].src = sd.para.server_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : this[r].src = sd.para.server_url + "?data=" + encodeURIComponent(_.base64Encode(e));
    };var saNewUser = { checkIsAddSign: function checkIsAddSign(e) {
        ...
        var t = null,
            ...
            n = {};null != r && _.isJSONString(r) && (n = JSON.parse(r), n.$device_id && (t = n.$device_id)), t = t || e, sd.para.cross_subdomain === !0 ? store.set("$device_id", t) : (n.$device_id = t, _.cookie.set("sensorsdata2015jssdkcross", JSON.stringify(n), null, !0)), sd.para.is_track_device_id && (_.info.currentProps.$device_id = t);
        ...
        var e = _.info.pageProp.url_domain,
            t = _.info.pageProp.referrer_domain;"" !== e && e !== t && sd.register({ $latest_referrer: _.info.pageProp.referrer, $latest_referrer_host: _.info.pageProp.referrer_host });var r = _.info.campaignParamsStandard("$latest_", "_latest_"),
            n = r.$utms,
            i = r.otherUtms;_.isEmptyObject(n) || sd.register(n), _.isEmptyObject(i) || sd.register(i);
      } },
        saEvent = {};saEvent.checkOption = { regChecks: { regName: /^((?!^distinct_id$|^original_id$|^time$|^properties$|^id$|^first_id$|^second_id$|^users$|^events$|^event$|^user_id$|^date$|^datetime$)[a-zA-Z_$][a-zA-Z\d_$]{0,99})$/i }, checkPropertiesKey: function checkPropertiesKey(e) {
        var t = this,
            r = !0;return _.each(e, function (e, n) {
      ...
      var r = { distinct_id: store.getDistinctId(), lib: { $lib: "js", $lib_method: "code", $lib_version: String(LIB_VERSION) }, properties: {} };if ("string" != typeof store.getDistinctId() || "" == typeof store.getDistinctId()) {
        var n = "";switch (store.getDistinctId()) {case null:
            n = "null";break;case void 0:
            n = "undefined";break;case "":
            n = "空";break;default:
            n = String(store.getDistinctId());}error_msg.push("distinct_id-" + just_test_distinctid + "-" + just_test_distinctid_2 + "-" + n + "-" + just_test_distinctid_detail + "-" + just_test_distinctid_detail2);
      ...
      var r = e,
          n = "";n = -1 !== sd.para.debug_mode_url.indexOf("?") ? sd.para.debug_mode_url + "&data=" + encodeURIComponent(_.base64Encode(e)) : sd.para.debug_mode_url + "?data=" + encodeURIComponent(_.base64Encode(e)), _.ajax({ url: n, type: "GET", cors: !0, header: { "Dry-Run": String(sd.para.debug_mode_upload) }, success: function success(e) {
          _.isEmptyObject(e) === !0 ? alert("debug数据发送成功" + r) : alert("debug失败 错误原因" + JSON.stringify(e));
        } });
    };var store = sd.store = { _sessionState: {}, _state: {}, getProps: function getProps() {
        ...
        var t = this._state.props || {};_.extend(t, e), this.set("props", t);
      }, setPropsOnce: function setPropsOnce(e) {
        var t = this._state.props || {};_.coverExtend(t, e), this.set("props", t);
      }, clearAllProps: function clearAllProps() {
        this._sessionState = {};for (var e in this._state.props) {
        ...
        var e = "";return sd.para.cross_subdomain === !1 ? (e = _.url("sub", location.href), e = "string" == typeof e && "" !== e ? "sa_jssdk_2015_" + e : "sa_jssdk_2015_root") : e = "sensorsdata2015jssdkcross", e;
      }, init: function init() {
        navigator.cookieEnabled || (error_msg.push("cookieNotEnable"), _.localStorage.isSupport || error_msg.push("localStorageNotEnable")), this.initSessionState();var e = _.UUID(),
            t = _.cookie.get(this.getCookieName());null === t ? (is_first_visitor = !0, just_test_distinctid = 1, this.set("distinct_id", e)) : (just_test_distinctid = 2, just_test_distinctid_detail = JSON.stringify(t), just_test_distinctid_detail2 = navigator.userAgent + "^_^" + document.cookie, _.isJSONString(t) && JSON.parse(t).distinct_id || (is_first_visitor = !0), this.toState(t)), saNewUser.setDeviceId(e), saNewUser.storeInitCheck(), saNewUser.checkIsFirstLatest();
      } },
        commonWays = { getUtm: function getUtm() {
      ...
      }, trackHeatMap: function trackHeatMap(e) {
        if ("object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && e.tagName) {
          var t = e.tagName.toLowerCase(),
              r = e.parentNode.tagName.toLowerCase();"button" !== t && "a" !== t && "a" !== r && "button" !== r && "input" !== t && "textarea" !== t && heatmap.start(null, e, t);
        }
      }, autoTrackWithoutProfile: function autoTrackWithoutProfile(e) {
        this.autoTrack(_.extend(e, { not_set_profile: !0 }));
      }, autoTrack: function autoTrack(e, t) {
        e = _.isObject(e) ? e : {};var r = _.info.campaignParams(),
            n = {};for (var i in r) {
          -1 !== (" " + source_channel_standard + " ").indexOf(" " + i + " ") ? n["$" + i] = r[i] : n[i] = r[i];
        }is_first_visitor && !e.not_set_profile && sd.setOnceProfile(_.extend({ $first_visit_time: new Date(), $first_referrer: _.getReferrer(), $first_browser_language: navigator.language, $first_referrer_host: _.info.pageProp.referrer_host }, n)), e.not_set_profile && delete e.not_set_profile;var o = location.href;sd.para.is_single_page && _.addHashEvent(function () {
          var r = _.getReferrer(o);sd.track("$pageview", _.extend({ $referrer: r, $referrer_host: _.url("hostname", r) || "", $url: location.href, $url_path: location.pathname, $title: document.title }, n, e), t), o = location.href;
        }), sd.track("$pageview", _.extend({ $referrer: _.getReferrer(), $referrer_host: _.info.pageProp.referrer_host, $url: location.href, $url_path: location.pathname, $title: document.title }, n, e), t);
      } };sd.quick = function () {
      var e = slice.call(arguments),
          t = e[0],
          r = e.slice(1);return "string" == typeof t && commonWays[t] ? commonWays[t].apply(commonWays, r) : void ("function" == typeof t ? t.apply(sd, r) : logger.info("quick方法中没有这个功能" + e[0]));
      ...
      function n(e) {
        ...
        }e.preventDefault();var o = !1;setTimeout(n, 1e3), sd.track(t, r, n);
      }e = e || {};var i = null;return e.ele && (i = e.ele), e.event && (i = e.target ? e.target : e.event.target), r = r || {}, i && "object" == (typeof i === "undefined" ? "undefined" : _typeof(i)) ? !i.href || /^javascript/.test(i.href) || i.target || i.download || i.onclick ? (sd.track(t, r), !1) : (e.event && n(e.event), void (e.ele && _.addEvent(e.ele, "click", function (e) {
        n(e);
      }))) : !1;
    }, sd.trackLink = function (e, t, r) {
      _.trackLink({ ele: e }, t, r);
    }, sd.trackLinks = function (e, t, r) {
      return r = r || {}, e && "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? !e.href || /^javascript/.test(e.href) || e.target ? !1 : void _.addEvent(e, "click", function (n) {
        function i() {
          o || (o = !0, location.href = e.href);
        }n.preventDefault();var o = !1;setTimeout(i, 1e3), sd.track(t, r, i);
      }) : !1;
      ...
      }var n = e;_.isString(e) && (e = {}, e[n] = 1), saEvent.check({ propertiesMust: e }) && (r(e) ? saEvent.send({ type: "profile_increment", properties: e }, t) : logger.info("profile_increment的值只能是数字"));
    }, sd.deleteProfile = function (e) {
      saEvent.send({ type: "profile_delete" }, e), store.set("distinct_id", _.UUID());
    }, sd.unsetProfile = function (e, t) {
      var r = e,
          n = {};_.isString(e) && (e = [], e.push(r)), _.isArray(e) ? (_.each(e, function (e) {
      ...
      var r = store.getFirstId();"undefined" == typeof e ? r ? store.set("first_id", _.UUID()) : store.set("distinct_id", _.UUID()) : saEvent.check({ distinct_id: e }) ? t === !0 ? r ? store.set("first_id", e) : store.set("distinct_id", e) : r ? store.change("first_id", e) : store.change("distinct_id", e) : logger.info("identify的参数必须是字符串");
    }, sd.trackSignup = function (e, t, r, n) {
      saEvent.check({ distinct_id: e, event: t, properties: r }) && (saEvent.send({ original_id: store.getFirstId() || store.getDistinctId(), distinct_id: e, type: "track_signup", event: t, properties: r }, n), store.set("distinct_id", e));
      ...
      if (saEvent.check({ distinct_id: e })) {
        var t = store.getFirstId(),
            r = store.getDistinctId();e !== r && (t ? sd.trackSignup(e, "$SignUp") : (store.set("first_id", r), sd.trackSignup(e, "$SignUp")));
      } else logger.info("login的参数必须是字符串");
    }, sd.logout = function (e) {
      var t = store.getFirstId();t ? (store.set("first_id", ""), e === !0 ? store.set("distinct_id", _.UUID()) : store.set("distinct_id", t)) : logger.info("没有first_id，logout失败");
    };var heatmap_render = { showErrorInfo: function showErrorInfo(e, t) {
        var r = document.createElement("div");r.setAttribute("style", "background:#e55b41;border:none;border-radius:8px;color:#fff;font-size:18px;left:50%;margin-left:-300px;padding:15px;position: fixed;text-align: center;top: 0;width:600px;z-index:9999;"), 1 === e ? r.innerHTML = "当前页面在所选时间段内暂时没有点击数据" : 2 === e ? t.error ? r.innerHTML = t.error : r.innerHTML = "请求数据异常" : 3 === e ? r.innerHTML = "当前页面在所选时间段内暂时没有点击数据" : 4 === e && (t.error ? r.innerHTML = t.error : r.innerHTML = "请求数据异常"), document.body.appendChild(r), setTimeout(function () {
          document.body.removeChild(r);
        }, 5e3);
      }, requestType: 1, getRequestInfo: function getRequestInfo(e, t) {
        var r = this;if ("string" == typeof e && sd.para.web_url) {
          var n = new _.urlParse(sd.para.web_url);n._values.Path = "/api/heat_map/report/" + e;var i = new _.urlParse(sd.para.web_url);i._values.Path = "/api/heat_map/report/path/" + e, t ? (this.requestType = 3, _.ajax({ url: i.getUrl() + "?pathUrl=" + t, type: "POST", cors: !0, header: { cors: "true" }, success: function success(e) {
            ...
            } })) : (this.requestType = 1, _.ajax({ url: n.getUrl(), type: "POST", cors: !0, header: { cors: "true" }, success: function success(e) {
              r.bindEffect(), r.calculateHeatData(e);
            }, error: function error(e) {
      ...
      }, calculateHeatData: function calculateHeatData(e) {
        var t = this;if (!_.isObject(e) || !_.isArray(e.rows) || !_.isObject(e.rows[0])) return t.showErrorInfo(t.requestType), !1;var r = parseInt(e.page_view, 10),
            n = e.heat_map_id;e = e.rows;var i = 0,
            o = [];_.each(e, function (e) {
          e.by_values[0] && _.querySelectorAll(e.by_values[0])[0] && o.push(e);
        }), 0 === o.length && t.showErrorInfo(t.requestType), e = o, _.each(e, function (e, t) {
          e.value_fix = e.values[0][0], i += e.value_fix;
        }), t.data_render = e, _.each(e, function (e, o) {
          if (e.by_values[0]) {
            e.data_page_percent = Number(e.value_fix / i * 100).toFixed(2) + "%", e.data_click_percent = Number(e.value_fix / r * 100).toFixed(2) + "%", e.data_click = Number(e.value_fix / r), e.data_page = Number(e.value_fix / i);var a = new _.urlParse(sd.para.web_url);a._values.Path = "/web-click/users", e.data_user_link = a.getUrl() + "#heat_map_id=" + n + "&element_selector=" + encodeURIComponent(e.by_values[0]), "null" === String(e.top_values[0]) ? e.data_top_value = "没有值" : e.data_top_value = String(e.top_values[0]);var s = _.querySelectorAll(e.by_values[0]);"object" == (typeof s === "undefined" ? "undefined" : _typeof(s)) && s.length > 0 && t.renderHeatData(s, e, o);
          }
        });
      }, heatData: function heatData(e) {
        for (var t = [.005, .01, .025, .05, .1, .5], r = 0; r < t.length; r++) {
          if (e < t[r]) return r;
        }return 6;
      }, heatDataTitle: function heatDataTitle(e) {
        return "点击次数 " + e.value_fix + "\r\n点击概率 " + e.data_click_percent + "\r\n点击占比 " + e.data_page_percent + "\r\n历史数据 " + String(e.top_values[0]).slice(0, 30);
      }, renderHeatData: function renderHeatData(e, t, r) {
        var n = _.ry(e[0]);n.attr("data-heat-place", String(r)).addClass("sa-click-area").attr("data-click", t.data_click_percent).addClass("sa-click-area" + this.heatData(t.data_click)), "inline" === n.getStyle("display") && (e[0].style.display = "inline-block");
      }, is_fix_state: null, showEffectBox: function showEffectBox(e, t, r) {
        if ("fixslidedown" === this.is_fix_state) t.style.position = "fixed", t.style.left = "auto", t.style.right = 0, t.style.top = 0, r && (t.className = "sa-heat-box-effect-2017314");else if ("notfix" === this.is_fix_state) {
          var n = heatmap.getBrowserWidth(),
              i = e.target,
              o = _.ry(i).offset(),
              a = _.ry(i).getSize(),
              s = o.left + a.width + 2,
              c = o.top + 1;s + 220 > n && (s = o.left - 220, o.left < 220 && (s = e.pageX)), t.style.position = "absolute", t.style.left = s + "px", t.style.top = c + "px";
        }"block" !== t.style.display && (t.style.display = "block");
      }, bindEffect: function bindEffect() {
        function e(e) {
          n = e;var t = e.target,
              i = t.getAttribute("data-heat-place"),
              l = r.data_render[i];if (!l) return !1;var d = _.trim(t.textContent);d && (d = d.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)), l.data_current_content = d || "没有值", a = o.replace(/\{\{[^\{\{]+\}\}/g, function (e) {
            return e = e.slice(2, -2), "string" == typeof e && "object" == (typeof l === "undefined" ? "undefined" : _typeof(l)) ? l[e] : void 0;
          }), f.innerHTML = a, r.showEffectBox(e, c, s);
        }function t(t) {
          var r = t.target;setTimeout(function () {
            r === y && e(t);
          }, b);
        }var r = this,
            n = null,
        ...
        var e = '.sa-heat-box-head-2017322{border-bottom:1px solid rgba(0,0,0,.06);cursor:move;height:30px;background:#E1E1E1;color:#999;clear:both}.sa-heat-box-effect-2017314{animation-duration:.5s;animation-fill-mode:both;animation-iteration-count:1;animation-name:sa-heat-box-effect-2017314}@keyframes sa-heat-box-effect-2017314{0%{opacity:.6}100%{opacity:1}}.sa-click-area{position:relative}.sa-click-area:before{cursor:pointer;content:"";width:100%;position:absolute;left:0;top:0;bottom:0}.sa-click-area.sa-click-area0:before{background:rgba(254,254,155,.75);box-shadow:0 0 0 2px rgba(254,254,155,1) inset}.sa-click-area.sa-click-area0:hover::before{background:rgba(254,254,155,.85)}.sa-click-area.sa-click-area1:before{background:rgba(255,236,142,.75);box-shadow:0 0 0 2px rgba(255,236,142,1) inset}.sa-click-area.sa-click-area1:hover::before{background:rgba(255,236,142,.85)}.sa-click-area.sa-click-area2:before{background:rgba(255,188,113,.75);box-shadow:0 0 0 2px rgba(255,188,113,1) inset}.sa-click-area.sa-click-area2:hover::before{background:rgba(255,188,113,.85)}.sa-click-area.sa-click-area3:before{background:rgba(255,120,82,.75);box-shadow:0 0 0 2px rgba(255,120,82,1) inset}.sa-click-area.sa-click-area3:hover::before{background:rgba(255,120,82,.85)}.sa-click-area.sa-click-area4:before{background:rgba(255,65,90,.75);box-shadow:0 0 0 2px rgba(255,65,90,1) inset}.sa-click-area.sa-click-area4:hover::before{background:rgba(255,65,90,.85)}.sa-click-area.sa-click-area5:before{background:rgba(199,0,18,.75);box-shadow:0 0 0 2px rgba(199,0,18,1) inset}.sa-click-area.sa-click-area5:hover::before{background:rgba(199,0,18,.85)}.sa-click-area.sa-click-area6:before{background:rgba(127,0,79,.75);box-shadow:0 0 0 3px rgba(127,0,79,1) inset}.sa-click-area.sa-click-area6:hover::before{background:rgba(127,0,79,.85)}.sa-click-area .sa-click-area:before{background:0 0!important}.sa-click-area:after{height:14px;line-height:14px;margin:-7px 0 0 -28px;width:56px;color:#fff;content:attr(data-click);font-size:14px;font-weight:700;left:50%;line-height:1em;position:absolute;text-align:center;text-indent:0;text-shadow:1px 1px 2px #000;top:50%;z-index:10}',
            t = document.createElement("style");t.type = "text/css";try {
          t.appendChild(document.createTextNode(e));
        } catch (r) {
          t.styleSheet.cssText = e;
        }document.getElementsByTagName("head")[0].appendChild(t);
      } },
        heatmap = { getDomIndex: function getDomIndex(e) {
        var t = [].indexOf;if (!e.parentNode) return -1;var r = e.parentNode.children;if (!r) return -1;var n = r.length;if (t) return t.call(r, e);for (var i = 0; n > i; ++i) {
          if (e == r[i]) return i;
        }return -1;
      }, selector: function selector(e) {
        var t = e.parentNode && 9 == e.parentNode.nodeType ? -1 : this.getDomIndex(e);return e.tagName.toLowerCase() + (e.id ? "#" + e.id : "") + (~t ? ":nth-child(" + (t + 1) + ")" : "");
      }, getDomSelector: function getDomSelector(e, t) {
        if (!e || !e.parentNode || !e.parentNode.children) return !1;t = t && t.join ? t : [];var r = e.nodeName.toLowerCase();return e && "body" !== r && 1 == e.nodeType ? (t.unshift(this.selector(e)), e.id ? t.join(" > ") : this.getDomSelector(e.parentNode, t)) : (t.unshift("body"), t.join(" > "));
      }, na: function na() {
        ...
        var e = parseInt(document.body.scrollHeight, 10);return isNaN(e) ? 0 : e;
      }, W: function W(e) {
        var t = parseInt(+e.clientX + +this.na(), 10),
            e = parseInt(+e.clientY + +this.i(), 10);return { x: isNaN(t) ? 0 : t, y: isNaN(e) ? 0 : e };
      }, start: function start(e, t, r) {
        var n = this.getDomSelector(t),
            i = _.getEleInfo({ target: t });i.$element_selector = n ? n : "", "a" === r && sd.para.heatmap && sd.para.heatmap.isTrackLink === !0 ? _.trackLink({ event: e, target: t }, "$WebClick", i) : sd.track("$WebClick", i);
      }, sendIframeData: function sendIframeData() {
        var e = this;_.bindReady(function () {
          window && window.parent && window.parent.window && window !== window.parent.window && (window.parent.window.postMessage({ method: "setHeight", params: { height: e.getScrollHeight() } }, sd.para.web_url), window.parent.window.postMessage({ method: "setUrl", params: { url: location.href } }, sd.para.web_url));
        });
      }, prepare: function prepare(e) {
        function t(e, t) {
          return document.querySelectorAll ? (heatmap_render.setCssStyle(), heatmap_render.getRequestInfo(e, t), void n.sendIframeData()) : (alert("请更新到最新版浏览器,建议用chrome或者firefox"), !1);
        }var r = location.search.match(/sa-request-id=([^&]+)/),
            n = this;r && r[0] && r[1] ? (sd.is_heatmap_render_mode = !0, "object" == _typeof(window.sessionStorage) && sessionStorage.setItem && sessionStorage.setItem("sensors_heatmap_id", r[1]), t(r[1])) : "object" == _typeof(window.sessionStorage) && sessionStorage.setItem && "string" == typeof sessionStorage.getItem("sensors_heatmap_id") ? (sd.is_heatmap_render_mode = !0, t(sessionStorage.getItem("sensors_heatmap_id"), location.href)) : (e(), _.isObject(sd.para.heatmap) && this.init());
      }, init: function init() {
        var e = this;return _.isObject(sd.para.heatmap) ? _.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url() ? !1 : ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void ("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (t) {
          var r = t || window.event,
              ...
              i = n.tagName.toLowerCase();if ("body" === i.toLowerCase() || "html" === i.toLowerCase()) return !1;if (!n || !n.parentNode || !n.parentNode.children) return !1;var o = n.parentNode.tagName.toLowerCase();"a" === o || "button" === o ? e.start(r, n.parentNode, n.parentNode.tagName.toLowerCase()) : e.start(r, n, i);
        }) : _.addEvent(document, "click", function (t) {
          var r = t || window.event,
              n = r.target || r.srcElement,
              i = n.tagName.toLowerCase();if ("body" === i.toLowerCase() || "html" === i.toLowerCase()) return !1;if (!n || !n.parentNode || !n.parentNode.children) return !1;var o = n.parentNode.tagName.toLowerCase();("button" === i || "a" === i || "a" === o || "button" === o || "input" === i || "textarea" === i) && ("a" === o || "button" === o ? e.start(r, n.parentNode, n.parentNode.tagName.toLowerCase()) : e.start(r, n, i));
        }))) : !1;
      } };sd.init = function () {
  ...
  25: [function (require, module, exports) {
    ...
    module.exports = {
      ...
      is: function is(it) {
        var O = Object(it),
            _Symbol = $.g.Symbol;
        return (_Symbol && _Symbol.iterator || FF_ITERATOR) in O || SYMBOL_ITERATOR in O || $.has(Iterators, classof(O));
      },
      get: function get(it) {
  ...
  77: [function (require, module, exports) {
    ...
    function wrap(tag) {
      ...
      DESC && setter && setSymbolDesc(ObjectProto, tag, {
        configurable: true, set: function set(value) {
  ...
  94: [function (require, module, exports) {
    (function (process, global) {
      !function (global) {
        ...
        Context.prototype = {
          constructor: Context, reset: function reset() {
            this.prev = 0;
            this.next = 0;
            this.sent = undefined;
            this.done = false;
